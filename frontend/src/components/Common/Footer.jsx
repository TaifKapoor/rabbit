         ...
         <div >
            ...
            <form  className="flex">
              <input type="email"
               ...
               className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus-within:ring-gray-500 transition-all' required/>
