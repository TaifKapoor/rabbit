...
const ProductDetails = ({ productId }) => {
  ...
  useEffect(() => {
    if (productFetchId) {
      console.log("Product ID being fetched:", productFetchId); // 🔍 Yeh line add karo
                ...
                <div className="flex gap-2 mt-2">
                  {selectedProduct.sizes.map((size) => (
                    <button
                      ...
                      key={size}
                      className={`px-4 py-2 rounded border ${selectedSize === size ? "bg-black text-white" : ""}`}>{size}
                    </button>
                  ))}
                </div>
              </div>
                ...
                <table className='w-full text-left text-sm text-gray-600'>
                  <tbody>
                    <tr>
                      ...
                      <td className='py-1'>{selectedProduct.barnd}</td>
                    </tr>
                    <tr>
